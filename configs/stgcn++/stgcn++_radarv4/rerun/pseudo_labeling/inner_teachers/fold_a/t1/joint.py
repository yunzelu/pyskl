...
# Outer fold A, teacher T1, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_a_t1_joint.pkl'
...
# Train subjects: dengdeng, jiadi, mia, rose, xilai, yunze
# Pseudo-target subjects: hui, chenzhe
# Pseudo-target windows: 10811
...
# 0: lie-stationary: n=6950, expected=5606.4
# 1: sit-stationary: n=3210, expected=3810.2
# 2: walk: n=13414, expected=7788.8
# 3: fall: n=1056, expected=2185.4
# 4: transition-lie-to-sit: n=1405, expected=2520.7
# 5: transition-lie-to-stand: n=2833, expected=3579.4
# 6: transition-sit-to-lie: n=1230, expected=2358.5
# 7: transition-sit-to-stand: n=1028, expected=2156.2
# 8: transition-stand-to-sit: n=1356, expected=2476.4
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_a/t1/joint'
