...
# Outer fold A, teacher T4, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_a_t4_joint.pkl'
...
# Train subjects: chenzhe, dengdeng, hui, jiadi, mia, rose
# Pseudo-target subjects: yunze, xilai
# Pseudo-target windows: 11191
...
# 0: lie-stationary: n=7222, expected=5674.2
# 1: sit-stationary: n=3280, expected=3824.0
# 2: walk: n=12708, expected=7526.9
# 3: fall: n=1076, expected=2190.2
# 4: transition-lie-to-sit: n=1428, expected=2523.1
# 5: transition-lie-to-stand: n=3054, expected=3689.9
# 6: transition-sit-to-lie: n=1089, expected=2203.4
# 7: transition-sit-to-stand: n=1030, expected=2142.9
# 8: transition-stand-to-sit: n=1215, expected=2327.4
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_a/t4/joint'
