...
# Outer fold C, teacher T4, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_c_t4_joint.pkl'
...
# Train subjects: chenzhe, dengdeng, hui, li, saad, xilai
...
# 0: lie-stationary: n=5528, expected=4989.7
# 1: sit-stationary: n=3488, expected=3963.5
# 2: walk: n=14223, expected=8003.6
# 3: fall: n=1094, expected=2219.7
# 4: transition-lie-to-sit: n=1283, expected=2403.8
# 5: transition-lie-to-stand: n=2980, expected=3663.5
# 6: transition-sit-to-lie: n=1169, expected=2294.5
# 7: transition-sit-to-stand: n=1147, expected=2272.9
# 8: transition-stand-to-sit: n=1488, expected=2588.8
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_c/t4/joint'
