...
# Outer fold C, teacher T2, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_c_t2_joint.pkl'
...
# Fixed outer roles:
# Outer validation subject: rose
# Outer calibration subject: mia
# Outer test subject excluded: yunze
# Inner cross-fitting roles:
# Train subjects: chenzhe, dengdeng, han, hui, jiadi, saad
# Pseudo-target subjects: li, xilai
# Pseudo-target windows: 10561
...
# 0: lie-stationary: n=6435, expected=5389.2
# 1: sit-stationary: n=3603, expected=4032.5
# 2: walk: n=13443, expected=7789.2
# 3: fall: n=1113, expected=2241.3
# 4: transition-lie-to-sit: n=1399, expected=2512.8
# 5: transition-lie-to-stand: n=3053, expected=3712.0
# 6: transition-sit-to-lie: n=1156, expected=2284.2
# 7: transition-sit-to-stand: n=1163, expected=2291.1
# 8: transition-stand-to-sit: n=1409, expected=2521.8
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_c/t2/joint'
