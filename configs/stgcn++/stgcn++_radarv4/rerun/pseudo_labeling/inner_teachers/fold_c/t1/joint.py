...
# Outer fold C, teacher T1, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_c_t1_joint.pkl'
...
# Train subjects: dengdeng, han, jiadi, li, saad, xilai
...
# 0: lie-stationary: n=6260, expected=5316.3
# 1: sit-stationary: n=3484, expected=3966.1
# 2: walk: n=13768, expected=7884.2
# 3: fall: n=1018, expected=2143.9
# 4: transition-lie-to-sit: n=1283, expected=2406.8
# 5: transition-lie-to-stand: n=2849, expected=3586.5
# 6: transition-sit-to-lie: n=1209, expected=2336.3
# 7: transition-sit-to-stand: n=1154, expected=2282.6
# 8: transition-stand-to-sit: n=1499, expected=2601.5
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_c/t1/joint'
