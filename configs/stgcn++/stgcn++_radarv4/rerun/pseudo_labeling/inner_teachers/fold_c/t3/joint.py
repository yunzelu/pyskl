...
# Outer fold C, teacher T3, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_c_t3_joint.pkl'
...
# Train subjects: chenzhe, han, hui, jiadi, li, xilai
# Pseudo-target subjects: dengdeng, saad
# Pseudo-target windows: 11028
...
# 0: lie-stationary: n=5822, expected=5145.7
# 1: sit-stationary: n=2844, expected=3596.5
# 2: walk: n=14624, expected=8155.4
# 3: fall: n=1017, expected=2150.7
# 4: transition-lie-to-sit: n=1333, expected=2462.2
# 5: transition-lie-to-stand: n=2878, expected=3617.9
# 6: transition-sit-to-lie: n=1209, expected=2344.9
# 7: transition-sit-to-stand: n=1120, expected=2256.9
# 8: transition-stand-to-sit: n=1460, expected=2576.8
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_c/t3/joint'
