...
# Outer fold B, teacher T1, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_b_t1_joint.pkl'
...
# Fixed outer roles:
# Outer validation subject: hui
# Outer calibration subject: chenzhe
# Outer test subject excluded: dengdeng
# Inner cross-fitting roles:
# Train subjects: han, jiadi, rose, saad, xilai, yunze
# Pseudo-target subjects: li, mia
# Pseudo-target windows: 11017
...
# 0: lie-stationary: n=5706, expected=5088.2
# 1: sit-stationary: n=3515, expected=3993.6
# 2: walk: n=14360, expected=8071.9
# 3: fall: n=1114, expected=2248.2
# 4: transition-lie-to-sit: n=1355, expected=2479.5
# 5: transition-lie-to-stand: n=2685, expected=3490.4
# 6: transition-sit-to-lie: n=1269, expected=2399.6
# 7: transition-sit-to-stand: n=1146, expected=2280.3
# 8: transition-stand-to-sit: n=1575, expected=2673.3
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_b/t1/joint'
