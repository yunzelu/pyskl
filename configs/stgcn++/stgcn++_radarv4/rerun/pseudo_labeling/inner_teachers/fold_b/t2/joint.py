...
# Outer fold B, teacher T2, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_b_t2_joint.pkl'
...
# Train subjects: han, jiadi, li, mia, saad, yunze
# Pseudo-target subjects: rose, xilai
# Pseudo-target windows: 10732
...
# 0: lie-stationary: n=6372, expected=5420.5
# 1: sit-stationary: n=3473, expected=4001.8
# 2: walk: n=14280, expected=8114.6
# 3: fall: n=1021, expected=2169.8
# 4: transition-lie-to-sit: n=1379, expected=2521.7
# 5: transition-lie-to-stand: n=2608, expected=3467.8
# 6: transition-sit-to-lie: n=1261, expected=2411.4
# 7: transition-sit-to-stand: n=1146, expected=2298.8
# 8: transition-stand-to-sit: n=1470, expected=2603.5
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_b/t2/joint'
