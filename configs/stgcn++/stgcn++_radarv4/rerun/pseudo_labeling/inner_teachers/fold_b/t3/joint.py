...
# Outer fold B, teacher T3, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_b_t3_joint.pkl'
...
# Train subjects: han, jiadi, li, mia, rose, xilai
# Pseudo-target subjects: yunze, saad
# Pseudo-target windows: 11058
...
# 0: lie-stationary: n=6581, expected=5518.1
# 1: sit-stationary: n=2949, expected=3693.8
# 2: walk: n=14435, expected=8172.4
# 3: fall: n=971, expected=2119.6
# 4: transition-lie-to-sit: n=1327, expected=2477.9
# 5: transition-lie-to-stand: n=2723, expected=3549.5
# 6: transition-sit-to-lie: n=1194, expected=2350.4
# 7: transition-sit-to-stand: n=1081, expected=2236.4
# 8: transition-stand-to-sit: n=1423, expected=2565.9
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_b/t3/joint'
