...
# Outer fold B, teacher T4, stream joint
# Generated by rerun/pseudo_labeling/generate_inner_teacher_training_artifacts.py
# ============================================================

stream = 'j'
dataset_type = 'PoseDataset'
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/inner_teachers_continuous_window_w60_s12/radarv4_yolo26xpose_continuous_window_w60_s12_inner_fold_b_t4_joint.pkl'
...
# Pseudo-target subjects: jiadi, han
# Pseudo-target windows: 10935
...
# 0: lie-stationary: n=5599, expected=5077.3
# 1: sit-stationary: n=3491, expected=4009.2
# 2: walk: n=14843, expected=8266.9
# 3: fall: n=1073, expected=2222.7
# 4: transition-lie-to-sit: n=1306, expected=2452.2
# 5: transition-lie-to-stand: n=2598, expected=3458.6
# 6: transition-sit-to-lie: n=1244, expected=2393.3
# 7: transition-sit-to-stand: n=1115, expected=2265.8
# 8: transition-stand-to-sit: n=1538, expected=2661.1
...
work_dir = './work_dirs/rerun/pseudo_labeling/inner_teachers/fold_b/t4/joint'
