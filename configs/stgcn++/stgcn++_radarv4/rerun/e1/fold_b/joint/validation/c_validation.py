...
# Base config: configs/stgcn++/stgcn++_radarv4/rerun/e1/fold_b/joint/c_triangular_temporal_composition.py
...
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/continuous_window_w60_s12_triangular/radarv4_yolo26xpose_continuous_window_w60_s12_triangular_fold_b.pkl'
...
# 0: lie-stationary: n=8086, expected=7036.6
# 1: sit-stationary: n=4476, expected=5235.3
# 2: walk: n=19306, expected=10872.8
# 3: fall: n=1393, expected=2920.6
# 4: transition-lie-to-sit: n=1789, expected=3309.8
# 5: transition-lie-to-stand: n=3538, expected=4654.5
# 6: transition-sit-to-lie: n=1656, expected=3184.4
# 7: transition-sit-to-stand: n=1496, expected=3026.7
# 8: transition-stand-to-sit: n=2002, expected=3501.3
...
work_dir = './work_dirs/rerun/e1/fold_b/joint/c_triangular_temporal_composition'
...
work_dir = 'work_dirs/rerun/e1/fold_b/joint/c_triangular_temporal_composition/validation'
