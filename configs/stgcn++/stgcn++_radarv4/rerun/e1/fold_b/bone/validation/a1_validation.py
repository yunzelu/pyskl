...
# Base config: configs/stgcn++/stgcn++_radarv4/rerun/e1/fold_b/bone/a1_activity_aligned.py
...
work_dir = 'work_dirs/rerun/e1/fold_b/bone/a1_activity_aligned/validation'
