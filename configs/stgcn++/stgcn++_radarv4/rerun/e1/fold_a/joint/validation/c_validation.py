...
# Base config: configs/stgcn++/stgcn++_radarv4/rerun/e1/fold_a/joint/c_triangular_temporal_composition.py
...
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/continuous_window_w60_s12_triangular/radarv4_yolo26xpose_continuous_window_w60_s12_triangular_fold_a.pkl'
...
# Train subjects: chenzhe, dengdeng, hui, jiadi, mia, rose, xilai, yunze
# Validation subject: han
# Calibration subject: saad
# Test subject: li
...
# 0: lie-stationary: n=8705, expected=7244.9
# 1: sit-stationary: n=4199, expected=5031.7
# 2: walk: n=18332, expected=10513.6
# 3: fall: n=1452, expected=2958.9
# 4: transition-lie-to-sit: n=1888, expected=3374.0
# 5: transition-lie-to-stand: n=3904, expected=4851.8
# 6: transition-sit-to-lie: n=1602, expected=3108.0
# 7: transition-sit-to-stand: n=1402, expected=2907.5
# 8: transition-stand-to-sit: n=1809, expected=3302.7
...
work_dir = './work_dirs/rerun/e1/fold_a/joint/c_triangular_temporal_composition'
...
work_dir = 'work_dirs/rerun/e1/fold_a/joint/c_triangular_temporal_composition/validation'
