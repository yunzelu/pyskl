# ============================================================
# Rerun E1 validation-subject evaluation: A1
# Base config: configs/stgcn++/stgcn++_radarv4/rerun/e1/fold_a/joint/a1_activity_aligned.py
...
ann_file = 'data/radar_v4/rerun/yolo26xpose/pyskl/activity_aligned/radarv4_yolo26xpose_activity_aligned_fold_a.pkl'
...
# 0: lie-stationary: n=941, expected=824.7
# 1: sit-stationary: n=497, expected=599.3
# 2: walk: n=1060, expected=875.3
# 3: fall: n=475, expected=585.9
# 4: transition-lie-to-sit: n=476, expected=586.5
# 5: transition-lie-to-stand: n=471, expected=583.4
# 6: transition-sit-to-lie: n=476, expected=586.5
# 7: transition-sit-to-stand: n=952, expected=829.5
# 8: transition-stand-to-sit: n=953, expected=829.9
...
work_dir = './work_dirs/rerun/e1/fold_a/joint/a1_activity_aligned'
...
work_dir = 'work_dirs/rerun/e1/fold_a/joint/a1_activity_aligned/validation'
