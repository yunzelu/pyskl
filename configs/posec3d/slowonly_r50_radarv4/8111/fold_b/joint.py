# ============================================================
# PoseC3D SlowOnly-R50 on RADAR v4 YOLO26x-pose skeletons, 8/1/1/1 fold
# Stream options: 'joint', 'limb'
# ============================================================

stream = 'joint'
pkl = 'radarv4_yolo26xpose_clip60_8111_fold_b_val_mia_calib_li_test_jiadi'
...
ann_file = f'data/radar_v4/pyskl/8111/{pkl}.pkl'
...
# Train counts:
# Falling: 469
# Lying-Stationary: 912
# Sit-Stationary: 478
# Transition-LayBed-to-Sit: 452
# Transition-LayFloor-to-Stand: 458
# Transition-Sit-to-LayBed: 453
# Transition-Sit-to-Stand: 913
# Transition-Stand-to-Sit: 915
# Walking: 1539
...
log_level = 'INFO'
work_dir = f'./work_dirs/posec3d/8111/{pkl}/{stream}'
