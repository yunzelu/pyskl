...
stream = 'joint'
pkl = 'radarv4_yolo26xpose_clip60_8111teacher4_fold_a_t2_val_han_calib_dengdeng_pseudo_li_mia'
...
# Source fold: fold_a
# Teacher: t2
# Train subjects: hui, jiadi, rose, saad, xilai, yunze
# Validation subject: han
# Calibration subject: dengdeng
# Pseudo-label target/test split: li, mia
