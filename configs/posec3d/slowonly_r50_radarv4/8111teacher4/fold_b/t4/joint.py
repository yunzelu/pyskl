...
stream = 'joint'
pkl = 'radarv4_yolo26xpose_clip60_8111teacher4_fold_b_t4_val_mia_calib_li_pseudo_xilai_yunze'
...
# Source fold: fold_b
# Teacher: t4
# Train subjects: chenzhe, dengdeng, han, hui, rose, saad
# Validation subject: mia
# Calibration subject: li
# Pseudo-label target/test split: xilai, yunze
