# ============================================================
# PoseC3D SlowOnly-R50 on RADAR v4 YOLO26x-pose skeletons, E5 teacher-4 split
# Stream options: 'joint', 'limb'
# ============================================================

stream = 'joint'
pkl = 'radarv4_yolo26xpose_clip60_8111teacher4_fold_b_t1_val_mia_calib_li_pseudo_chenzhe_dengdeng'
...
ann_file = f'data/radar_v4/pyskl/8111teacher4/{pkl}.pkl'
...
# E5 teacher-4 out-of-fold split:
# Source fold: fold_b
# Teacher: t1
# Train subjects: han, hui, rose, saad, xilai, yunze
# Validation subject: mia
# Calibration subject: li
# Pseudo-label target/test split: chenzhe, dengdeng
...
log_level = 'INFO'
work_dir = f'./work_dirs/posec3d/8111teacher4/{pkl}/{stream}'
