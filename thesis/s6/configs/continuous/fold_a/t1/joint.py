...
# Fold a, teacher t1, stream joint
...
log_level = 'INFO'
load_from = 'work_dirs/thesis/s6/trimmed/fold_a/t1/joint/best_macro_f1_epoch_8.pth'
resume_from = None
auto_resume = False
work_dir = './work_dirs/thesis/s6/continuous_hard/fold_a/t1/joint'
