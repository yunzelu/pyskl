...
python thesis/e4/calibrate_scores.py --stream "${STREAM}" --split val --overwrite
python thesis/e4/calibrate_scores.py --stream "${STREAM}" --split test --overwrite
python thesis/e4/tune_viterbi.py --stream "${STREAM}" --lambda-grid "${LAMBDA_GRID}" --overwrite
python thesis/e4/apply_viterbi.py --stream "${STREAM}" --overwrite
