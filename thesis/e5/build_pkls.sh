...
OUT_DIR="${OUT_DIR:-data/radar_v4/pyskl/8111teacher4}"
...
build_pkl() {
  ...
  local pkl="radarv4_yolo26xpose_clip60_8111teacher4_${fold}_${teacher}_val_${val_subject}_calib_${calib_subject}_pseudo_${pseudo_slug}"
...
# Fold A: val han, calib dengdeng, original test chenzhe.
...
# Fold B: val mia, calib li, original test jiadi.
...
# Fold C: val yunze, calib xilai, original test saad.
