...
def generate_gantt_chart(json_path, output_image_path):
    ...
    config = {
        ...
        "LayBed-Stationary":            {"level": 10, "color": "#2980b9"}, # Dark Blue
        "LayFloor-Stationary":          {"level": 11, "color": "#2980b9"}, # Dark Blue
    }
    ...
    ax.set_title("Activity Timelin - GT - 12C", fontsize=16, pad=20)
