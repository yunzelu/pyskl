...
if __name__ == "__main__":
    run_csv_visualizer(
        bg_image_path="pipeline/csv_input/Image.jpg", 
        video_out="pipeline/csv_input/yolo_pose_2026-03-14_copy_rendered.mp4",
        poses_path="pipeline/csv_input/yolo_pose_2026-03-14 copy.csv",
        actions_path="pipeline/csv_input/yolo_pose_2026-03-14_copy_result.json",
        fps=30 
    )