...
if __name__ == "__main__":
    run_csv_visualizer(
        bg_image_path="pipeline/csv_input/background.jpg", # Path to your static background
        video_out="pipeline/csv_input/12-12_rendered.mp4",
        poses_path="pipeline/csv_input/12-12_padded.csv",
        actions_path="pipeline/csv_input/12-12_result.json",
        fps=30 # Adjust this to match your original tracking system's framerate
    )