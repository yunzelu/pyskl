...
#SBATCH --job-name=pl_inner_a_t3_bone
...
cd "/project/def-mbolic/yunzelu/pyskl"l/

GPUS="${GPUS:-4}"
SEED="${SEED:-42}"
CONFIG="configs/stgcn++/stgcn++_radarv4/rerun/pseudo_labeling/inner_teachers/fold_a/t3/bone.py"
